...
root.resizable(width=False, height=False)# width and height cant be changed when we have assigned them as false 
...
txtDisplay = Entry(calc, font=('Helvetica',20,ITALIC),
				bg='red',fg='yellow',
				bd=30,width=28,justify=RIGHT)
txtDisplay.grid(row=0,column=0, columnspan=4, pady=3)
...
btnsq = Button(calc, text="\u221A",width=6, height=2,
			bg='purple',fg='yellow', font=('Helvetica',
									20,'bold'),
...
btnPM = Button(calc, text=chr(177),width=6,
			height=2,bg='purple',fg='yellow', font=('Helvetica',20,'bold'),
...
lblDisplay = Label(calc, text = "Scientific Calculator",
				...
				bg='green',fg='orange',justify=CENTER)

lblDisplay.grid(row=0, column= 4,columnspan=4)

def iExit():
	iExit = tkinter.messagebox.askyesno("Scientific Calculator",
										"If you want to exit press ok ")
	if iExit>0:
		root.destroy()
		return
